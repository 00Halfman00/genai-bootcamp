...
class Frontend(Construct):
    ...
    def __init__(
        ...
        **kwargs
        ...
        admin_s3_origin = origins.S3BucketOrigin.with_origin_access_control(
        ...
        admin_env_s3_origin = origins.S3BucketOrigin.with_origin_access_control(
            admin_env_bucket,
            origin_access_levels=[
                cloudfront.AccessLevel.READ,
                cloudfront.AccessLevel.LIST,
...
"""
        ...
        if custom_certificate_arn and custom_domain_name:
            ...
            certificate = Certificate.from_certificate_arn(
                self, "CustomCertificate", custom_certificate_arn
            )
        ...
        admin_frontend_deployment = s3deploy.BucketDeployment(
            self,
            "DeployAdminFrontend",
            sources=[
        ...
        admin_env_deployment = s3deploy.BucketDeployment(
            self,
            "DeployAdminEnv",
            sources=[s3deploy.Source.data("_app/env.js", env_js_content)],
